...
public class BaseDatos extends SQLiteOpenHelper {
    ...
    public void cargarDatos(SQLiteDatabase db){
        db.execSQL("INSERT INTO "+ConstantesBaseDatos.TABLE_MASCOTA+" VALUES(NULL,'Lola',"+ R.drawable.puppy1+",0)");
        db.execSQL("INSERT INTO "+ConstantesBaseDatos.TABLE_MASCOTA+" VALUES(NULL,'Paco',"+ R.drawable.puppy2+",0)");
        db.execSQL("INSERT INTO "+ConstantesBaseDatos.TABLE_MASCOTA+" VALUES(NULL,'Lucky',"+ R.drawable.puppy3+",0)");
        db.execSQL("INSERT INTO "+ConstantesBaseDatos.TABLE_MASCOTA+" VALUES(NULL,'Pity',"+ R.drawable.puppy4+",0)");
        db.execSQL("INSERT INTO "+ConstantesBaseDatos.TABLE_MASCOTA+" VALUES(NULL,'Peludo',"+ R.drawable.puppy5+",0)");
        db.execSQL("INSERT INTO "+ConstantesBaseDatos.TABLE_MASCOTA+" VALUES(NULL,'Laika',"+ R.drawable.puppy6+",0)");
